...
var PanelsBitch = [{ title: "bitch1", content: "biiiitch1" }, { title: "bitch2", content: "biiiitch2" }, { title: "bitch3", content: "biiiitch3" }];
    ...
    _createClass(Root, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_tabs2.default, { panels: PanelsBitch })
            );
        }
    }]);
...
var Clock = function (_React$Component) {
    ...
    _createClass(Clock, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "clock-fuck" },
                _react2.default.createElement(
                    "h1",
                    null,
                    "This is yo clock Biiiitch: "
                ),
                _react2.default.createElement(
                    "span",
                    null,
...
var Tabs = function (_React$Component) {
    ...
    _createClass(Tabs, [{
        key: "getFuckingIndex",
        value: function getFuckingIndex(element) {
            var fuckingIndex = Array.prototype.indexOf.call(element.parentNode.children, element);
            return fuckingIndex;
        }
    }, {
        key: "clickaroo",
        value: function clickaroo(event) {
            event.preventDefault();
            var currentTar = event.currentTarget;
        ...
        value: function render() {
            ...
            var currentTab = this.props.panels[this.state.selectedTabIndex];

            var headers = this.props.panels.map(function (tab, index) {
                var paneTitle = tab.title;
                var paneContent = tab.content;

                return _react2.default.createElement(
                    "li",
                    { key: index,
                        onClick: _this2.clickaroo.bind(_this2) },
                    paneTitle
                );
            });
